...
9 contracts are deployed on Base Sepolia and 10 on SKALE Base Sepolia. Changes require extra care:

- All contracts must compile with Solidity 0.8.20 (Base Sepolia) or 0.8.24 (SKALE Solidity fork)
